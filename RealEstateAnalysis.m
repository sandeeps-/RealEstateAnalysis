...
property_tax_base = .012 * purchase_price;
...
for I = 1:M
    ...
    inflation_adjustment = (inflation^I - 1)/(inflation - 1);
    total_payment_inflation_adjusted = emi * 12 * inflation_adjustment;
    total_payment = total_payment_inflation_adjusted;
    ...
    actual_investment = down_payment * inflation^M + total_payment + property_tax_Iyears + (misc_costs_per_year + insurance_cost_per_year) * inflation_adjustment;
